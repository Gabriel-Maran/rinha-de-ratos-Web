...
('Rato de Hospital','Mistura cura e combate: recupera vida e se fortalece quando preciso.','Sarna-Médico', 25, 40, 30, 50, 55, 70, 50, 70, 30, 45),
('Rato de Laboratório','Gênio dos experimentos: ganha buffs monstruosos com alto risco — recompensa ou desastre.','Cobaia 07', 40, 60, 40, 60, 35, 55, 60, 80, 20, 35),
('Rato de Fazenda','Tanque do campo: força bruta e golpes pesados que esmagam a defesa inimiga.','Tratorzinho', 60, 80, 25, 45, 55, 70, 20, 40, 40, 60),
('Rato de Cassino','Viciado em apostas: trapaças e jogadas de alto risco que podem virar a partida.','Aposta Alta', 35, 55, 45, 65, 30, 50, 55, 75, 25, 35),
...
(1, 'Leptospirose', '75% de chance de reduzir a DEF do alvo em 18% — 1 rodada. Falha: perde 6% do HP.', 75, '-18%DEFADV', '-6%HPSSEU', 'O cheiro da doença se espalha! A defesa do oponente nesta rodada foi reduzida em 18%.','Autoinfecção! O rato se descuida e perde 6% de HP.'),
(1, 'Nuvem de Lama', '72% de chance de reduzir a AGI do alvo em 20% — 1 rodada. Falha: perde 8% do PA na rodada.', 72, '-20%AGIADV', '-8%PASSEU', 'Uma plasta de lodo atinge o alvo! A agilidade do oponente nesta rodada foi reduzida em 20%.','O rato escorrega na própria lama! Seu PA foi reduzido nesta rodada em 8%.'),
(1, 'Fedor Corrosivo', '70% de chance de causar dano direto igual a 8% do HP máximo do alvo (instantâneo). Falha: perde 6% da DEF na rodada.', 70, '-8%HPSADV', '-6%DEFSEU', 'O ar se torna tóxico! O oponente sofre corrosão e perde 8% do HP.','O fedor vaza para trás! O rato corrói a própria armadura, perdendo 6% de DEF nesta rodada.');

-- Habilidades Classe 2: Rato de Hospital
INSERT INTO habilidades (id_classe, nome_habilidade, descricao, chance_sucesso, efeito_sucesso_str, efeito_falha_str, efetivo_txt, falha_txt) VALUES
(2, 'Autocurado', '80% de chance de regenerar 8% do HP máximo (instantâneo). Falha: perde 5% da DEF na rodada.', 80, '+8%HPSSEU', '-5%DEFSEU', 'Injeção aplicada! O rato recupera 8% de HP.','A seringa travou! O rato fica mais frágil: -5% DEF nesta rodada.'),
(2, 'Antisséptico', '78% de chance de ganhar +10% PA e +10% PD — 1 rodada. Falha: perde 5% do HP.', 78, '+10%PASSEU;+10%PDSSEU', '-5%HPSSEU', 'Limpeza total! +10% PA e +10% PD apenas nesta rodada!','Reação alérgica! O antisséptico causa 5% de dano de HP.'),
(2, 'Escudo Antígeno', '75% de chance de ganhar +15% PD — 1 rodada. Falha: perde 8% do HP e -5% DEF na rodada.', 75, '+15%PDSSEU', '-8%HPSSEU;-5%DEFSEU', 'Defesas ativadas! +15% PD apenas nesta rodada!','Sobrecarga imunológica! -8% HP e -5% DEF nesta rodada.');

-- Habilidades Classe 3: Rato de Laboratório
INSERT INTO habilidades (id_classe, nome_habilidade, descricao, chance_sucesso, efeito_sucesso_str, efeito_falha_str, efetivo_txt, falha_txt) VALUES
(3, 'Mutação Aguda', '70% de chance de ganhar +18% PA e +14% DEF — 1 rodada. Falha: perde 12% do HP.', 70, '+18%PASSEU;+14%DEFSEU', '-12%HPSSEU', 'Mutação bem-sucedida! +18% PA e +14% DEF apenas nesta rodada!','Mutação instável! O corpo rejeita e o rato perde 12% de HP.'),
(3, 'Soro Experimental', '60% de chance de ganhar +30% de chance crítica — 1 rodada. Falha: perde 10% do HP.', 60, '+30%CRISEU', '-10%HPSSEU', 'O soro funciona! +30% chance crítica nesta rodada!','Reação adversa! O soro é tóxico, o rato perde 10% de HP.'),
(3, 'Durateston', '60% de chance de ganhar +35% PA — 1 rodada. Falha: perde 18% do HP e -6% DEF na rodada.', 60, '+35%PASSEU', '-18%HPSSEU;-6%DEFSEU', 'Explosão de força! +35% PA apenas nesta rodada!','Sobrecarga! -18% HP e -6% DEF nesta rodada.');

-- Habilidades Classe 4: Rato de Fazenda
INSERT INTO habilidades (id_classe, nome_habilidade, descricao, chance_sucesso, efeito_sucesso_str, efeito_falha_str, efetivo_txt, falha_txt) VALUES
(4, 'Mordida de Saco', '80% de chance de ganhar +18% PA — 1 rodada. Falha: perde 6% do HP.', 80, '+18%PASSEU', '-6%HPSSEU', 'Ataque focado! +18% PA nesta rodada!','Dente travado! O rato erra e perde 6% de HP.'),
(4, 'Cascavel de Palha', '78% de chance de ganhar +18% DEF — 1 rodada. Falha: perde 10% da AGI na rodada.', 78, '+18%DEFSEU', '-10%AGISEU', 'Entrincheirado! +18% DEF nesta rodada!','Desequilíbrio! -10% AGI apenas nesta rodada.'),
(4, 'Saracoteia Rural', '72% de chance de reduzir a AGI do alvo em 14% e a STR em 9% — 1 rodada. Falha: perde 10% da AGI na rodada.', 72, '-14%AGIADV;-9%STRADV', '-10%AGISEU', 'Dança confusa! O oponente perde 14% AGI e 9% STR nesta rodada!','Tropeção! O rato perde 10% AGI apenas nesta rodada.');

-- Habilidades Classe 5: Rato de Cassino
INSERT INTO habilidades (id_classe, nome_habilidade, descricao, chance_sucesso, efeito_sucesso_str, efeito_falha_str, efetivo_txt, falha_txt) VALUES
(5, 'Dado Viciado', '60% de chance de ganhar +30% de chance crítica — 1 rodada. Falha: perde 10% do PA na rodada.', 60, '+30%CRISEU', '-10%PASSEU', 'A sorte sorri! +30% crítico nesta rodada!','Fumble! Os dados saem ruins, -10% PA apenas nesta rodada.'),
(5, 'Trapaceiro', '70% de chance de roubar 8% do HP do oponente (dano + cura instantânea). Falha: perde 10% do HP.', 70, '+8%HPSSEU;-8%HPSADV', '-10%HPSSEU', 'Trapaça perfeita! Rato drena 8% do HP do alvo e ganha a mesma quantidade.','Pego no ato! O rato é punido e perde 10% de HP.'),
(5, 'All-in', '50% de chance de multiplicar o PA por 3 (PA x3) — 1 rodada. Falha: sofre -40% PD e perde 10% do HP.', 50, '+200%PASSEU', '-40%PDSSEU;-10%HPSSEU', 'Tudo ou nada! PA multiplicado por 3 apenas nesta rodada!','Aposta perdida! -40% PD e -10% HP.');

...
-- Volta os HPs para os valores originais
...
=======
(5, 'All-in', '50% de chance de multiplicar o PA por 3 (PA x3) apenas nesta rodada. Falha: sofre -40% PD e perde 10% do HP.', 50, '+300%PASSEU', '-40%PDSSEU;-10%HPSSEU', 'Tudo ou nada! PA é multiplicado por 3 apenas nesta rodada!','Aposta perdida! -40% PD e -10% HP.');
>>>>>>> Stashed changes

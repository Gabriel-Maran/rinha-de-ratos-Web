...
(1, 'Leptospirose', '75% de chance de reduzir a DEF do alvo em 18% — efeito apenas nesta rodada. Falha: perde 6% do HP.', 75, '-18%DEFADV', '-6%HPSSEU', 'O cheiro da doença se espalha! A defesa do oponente nesta rodada foi reduzida em 18%.','Autoinfecção! O rato se descuida e perde 6% de HP.'),
...
(3, 'Soro Experimental', '60% de chance de ganhar +30% de chance crítica apenas nesta rodada. Falha: perde 10% do HP.', 60, '+30%CRISEU', '-10%HPSSEU', 'O soro funciona! +30% chance crítica nesta rodada!','Reação adversa! O soro é tóxico, o rato perde 10% de HP.'),
(3, 'Durateston', '60% de chance de ganhar +35% PA apenas nesta rodada. Falha: perde 18% do HP e -6% DEF apenas nesta rodada.', 60, '+35%PASSEU', '-18%HPSSEU;-6%DEFSEU', 'Explosão de força! +35% PA apenas nesta rodada!','Sobrecarga! -18% HP e -6% DEF nesta rodada.');

-- Habilidades Classe 4: Rato de Fazenda
INSERT INTO habilidades (id_classe, nome_habilidade, descricao, chance_sucesso, efeito_sucesso_str, efeito_falha_str, efetivo_txt, falha_txt) VALUES
(4, 'Mordida de Saco', '80% de chance de ganhar +18% PA apenas nesta rodada. Falha: perde 6% do HP.', 80, '+18%PASSEU', '-6%HPSSEU', 'Ataque focado! +18% PA nesta rodada!','Dente travado! O rato erra e perde 6% de HP.'),
...
INSERT INTO habilidades (id_classe, nome_habilidade, descricao, chance_sucesso, efeito_sucesso_str, efeito_falha_str, efetivo_txt, falha_txt) VALUES
(5, 'Dado Viciado', '60% de chance de ganhar +30% de chance crítica apenas nesta rodada. Falha: perde 10% do PA apenas nesta rodada.', 60, '+30%CRISEU', '-10%PASSEU', 'A sorte sorri! +30% crítico nesta rodada!','Fumble! Os dados saem ruins, -10% PA apenas nesta rodada.'),
...
(5, 'All-in', '50% de chance de multiplicar o PA por 3 (PA x3) apenas nesta rodada. Falha: sofre -40% PD e perde 10% do HP.', 50, '+200%PASSEU', '-40%PDSSEU;-10%HPSSEU', 'Tudo ou nada! PA multiplicado por 3 apenas nesta rodada!','Aposta perdida! -40% PD e -10% HP.');
